...
public class VariaveisLocais {
	...
	void teste1(){
		...
		if(a1 > 3){
			int a2 = 3; //Variavel n�o possivel acessa fora do escopo de void
		}
		
		//System.out.println(a2); //N�o � possivel acessar uma variavel que foi definida dentro de um escopo local
	}
